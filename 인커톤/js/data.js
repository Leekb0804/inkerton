const qnaList = [
    {
      q: '1. 나는 승부욕이 있다.',
      a: [
        { answer: 'a. 매우 아니다', type: ['cow', 'tiger', 'dragon', 'chick'] },
        { answer: 'b. 아니다', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
        { answer: 'c. 보통이다', type: ['sheep', 'pig'] },
        { answer: 'd. 그렇다', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
        { answer: 'e. 매우 그렇다', type: ['sheep', 'pig'] },
      ]
    },
    {
      q: '2. 나는 지식에 자신이 있는 편이다.',
      a: [
        { answer: 'a. 매우 아니다', type: ['cow', 'tiger', 'dragon', 'chick'] },
        { answer: 'b. 아니다', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
        { answer: 'c. 보통이다', type: ['sheep', 'pig'] },
    ...
    {
      q: '19. 나는 더운 여름에는 시원한 음료수를 마셔야 한다.',
      a: [
        { answer: 'a. 매우 아니다', type: ['cow', 'tiger', 'dragon', 'chick'] },
        { answer: 'b. 아니다', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
        { answer: 'c. 보통이다', type: ['sheep', 'pig'] },
